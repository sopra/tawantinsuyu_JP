...
ゲームの最初のあなたのターンに、あなたは自分の大司祭をコリカンチャタイル上のいずれかのスペースに配置することから始めます(他のプレイヤーの大司祭が既に占有している場合も同様です)。
この配置はあなたの大司祭の開始位置を決定するためのものであり、後述のルールに記載されている大司祭の二次的な行動と混同してはいけません。
...
加えて、あなたは自分の大司祭の位置や自分のワーカーの場所に応じて食料コストを支払わなければなりません。
...
丘の両側はそれぞれ1区画です。大司祭と同じ区画に配置するには1、隣接する区画に配置するには1、隣接しないセクションに配置するには3のコストがかかります。
...
ターン終了時に、プレイした神カードを奉納エリアに加えます。

もしプレイしたカードが4/5/6枚目のカード（それぞれ2/3/4人プレイの場合です）として奉納エリアに加えられる場合、奉納エリアから神カードをすべて取り除きシャフルして山札に戻します。

この作業が終わったら、貴方がプレイしたカードを奉納エリアに加えます。

**2人プレイでの例**

1. 貴方は神カードをプレイしてワーカーを配置しました。
ターン終了時にプレイしたカードを奉納エリアに置くところでしたが、これが4枚目であることが分かります。
2. 現在奉納エリアにあるカード3枚を山札に戻して、山札をシャッフルします。
3. その後、プレイしたカードを奉納エリアに加えます。
...
タスクを解決した後、あなたは山札か奉納エリアのいずれかから神カードを1枚引かなければなりません。
...
彫像は神カードのプレイや、後述する「大司祭による崇拝」アクションを実行したときをトリガーに利用できます。  

<br />

#### 織物の購入

![](img/task_weavings.png)
...
![](img/task_produceone.png)

即座に表向きになっている生産建物 1枚 に描かれている報酬を受け取ります。
この建物は表向きのままになります。（後述する大司祭による生産では裏向きになることがあります）
...
神カードを2枚引きます。
あなたは神カードの山札の上から1枚引くか、奉納エリアに並んでいるカードを1枚取るかを選べます。
山札の上から1枚引いたら、2枚目を引く前に引いたカードを確認してもかまいません。

---

注意：「神カードを引く」時はいつでも、山札の一番上から引くか、奉納エリアに並んでいるカードから取るかを選ぶことができます
...
（このフェーズ中では奉納エリアから神カードを取ることはできません）
...
この方法でプレイされたカードは山札に戻して、デッキをシャッフルします。奉納エリアには置きません。
